...
import world.bentobox.cauldronwitchery.utils.LibraryEntry;
import world.bentobox.cauldronwitchery.utils.Utils;


/**
 * This class contains all necessary elements to create GUI that lists all databases.
...
public class LibraryPanel extends CommonPagedPanel<LibraryEntry>
{
    ...
    private LibraryPanel(CommonPanel parentGUI, Library mode)
    {
        ...
        this.libraryEntries = switch (mode)
        {
            ...
            case WEB -> Collections.emptyList();
